...
describe('OperationCode', function () {
  ...
  describe('attr types', function () {
    before(async () => {
      const code = await testCase('numeric-attr.py');
  ...
  describe('example', function () {
    ...
    before(async function () {
      // load the example
      code = await testCase('example.py');
    });
    ...
    describe('parsing', function () {
      ...
      it('should parse the output name when returning attr', async function () {
        const code = await testCase('op-output-name.py');
  ...
  describe('multi-anon-results', function () {
    before(async function () {
      ...
      var example = await fs_readFilePromise(filePath, 'utf8');
  ...
  describe.skip('no-inputs/outputs', function () {
    ...
    before(async function () {
      ...
      code = await fs_readFilePromise(filePath, 'utf8');
    });
    describe('parsing', function () {
      beforeEach(function () {
        operation = new OperationCode(code);
    ...
    describe('attributes', function () {
      describe('get', function () {
        beforeEach(async function () {
          ...
          let code = await fs_readFilePromise(filePath, 'utf8');
          operation = new OperationCode(code);
        });
  ...
  async function testCase(name) {
    ...
    return fs_readFilePromise(filePath, 'utf8');
  }
});